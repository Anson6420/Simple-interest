  ...
  return (
    ...
    <div className='bg-dark d-flex justify-content-center align-items-center' style={{height:'100vh',width:'100%'}}>
      <div className='bg-light p-5 rounded-2' style={{width:'500px'}}>
        ...
        <div className='bg-warning p-3 d-flex justify-content-center align-items-center rounded flex-column' style={{height:'150px'}}>
          <h1>₹ {interest}</h1>
          <p>Total simple Interest</p>

        </div>
        <div className='my-3'> 
          <TextField id="outlined-basic" className='w-100' name='principle' value={principle} label="Principle amount" variant="outlined" onChange={(e)=>validate(e)} />
       {isPrinciple ==false && <p className='text-danger'>*Invalid Input</p>}

        </div>
        <div className='mb-3'>
        <TextField id="outlined-basic" className='w-100' name='rate' label="Rate of interest ()%" value={rate} variant="outlined" onChange={(e)=>validate(e)} />
        {isRate ==false &&    <p className='text-danger'>*Invalid Input</p>}
        </div>
        <div className='mb-3'>
        <TextField id="outlined-basic" className='w-100' name='year' label="Year (Yr)" value={year} variant="outlined" onChange={(e)=>validate(e)} />
